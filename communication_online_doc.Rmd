...
### Audience:
The workshop is aimed at PhD candidates, postdocs, (assistant-)professors and other researchers, as well as research support staff and research software engineers. We offer tickets for researchers who are affiliated with Dutch research institutions, and industry tickets for attendees who are not affiliated with Dutch research institutions. We do not accept registrations by Master students. 
...
On the workshop days (`r params$date`), please join the call 15 minutes early (`r params$start_time`) if possible to say hello to the instructors and fellow learners, and to check if your audio and video setup works correctly. That will allow us to start teaching on time.
...
You will receive a digital certificate of attendance within a few days after this email. Please note that we remove personal information from our database, including this certificate, after 8 months.
...
We are continuously organizing training events. You can follow us on [LinkedIn](https://www.linkedin.com/company/netherlands-escience-center/posts/?feedView=all) [4] and can find the list of upcoming events on the eScience Center’s [website](https://www.esciencecenter.nl/events/?f-workshops/) [5].

We also encourage you to subscribe to our [newsletter](http://eepurl.com/dtjzwP) [6] and select 'Training' to get invited to trainings and related events organized by the Netherlands eScience Center.
